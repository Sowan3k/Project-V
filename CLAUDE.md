...
neon checkout <name>   # create a throwaway branch for risky migrations
neon me                # check auth
```
...
untested migration, `neon checkout` a scratch branch and test there — a bad migration that
drops revision history violates invariant 2 and is not recoverable from application code.
